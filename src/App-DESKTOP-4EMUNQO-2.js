...
let newArray = questions.sort((a,b) => 0.5 - Math.random())
function App() {
  ...
  return (
      ...
      <div className="antialised bg-gradient-to-r from-purple-400 to-blue-500 h-screen">
          <div className='flex w-full h-screen justify-center items-center'>
              ...
              <div className= ' bg-purple-600 p-12 rounded-lg shadow-lg w-full h-4/5 mt-10 '>
              <div className='items-center '>
                <p className='text-center text-slate-200 font-medium text-4xl'>Question {newArray[currentQuestion]} out of 10 </p>
